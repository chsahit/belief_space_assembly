...
back_bottom = set((("big_fixed_puzzle::b4", "block::200"),))
top_touch = set((("big_fixed_puzzle::b3", "block::201"),))
b_top_touch = set((("big_fixed_puzzle::b4", "block::202"),))
front_touch = set((("big_fixed_puzzle::b3", "block::300"),))
front_touch_c = set((("big_fixed_puzzle::b3", "block::302"),))
ft = set(
    (
...
back_touch = set((("big_fixed_puzzle::b4", "block::301"),))
bottom = set((("big_fixed_puzzle::b1", "block::000"),))
side = set(
    (
        ("big_fixed_puzzle::b1", "block::000"),
        ("big_fixed_puzzle::b2", "block::101"),
        ("big_fixed_puzzle::b2", "block::100"),
    )
)
...
def puzzle_search():
    ...
    modes = [b_top_touch, ft, ft, bottom, side]
